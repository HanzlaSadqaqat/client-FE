  ...
  return (
    <>
      <div className="flex flex-col gap-3">
        ...
        <div>
          <div className="border-2 border-gray-100 border-solid flex md:flex-1 flex-col gap-5 items-center justify-start pb-[19px] rounded-[15px] ">
            ...
            <div className="flex flex-col gap-3 items-start justify-start w-full md:w-full pl-3 pr-3">
              <div className="flex flex-col  gap-2 justify-start w-auto">
                <Text
                  className="text-gray-900 text-sm w-auto flex gap-1 items-center"
                  size="txtNunitoSemiBold14Gray900"
                >
                  <IoIosInformationCircleOutline className="text-purple-600" />

                  <span>Policy Status Goes Here</span>
                </Text>
                <Text
